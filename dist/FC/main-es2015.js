...
class MetricaVisualizarI {
    constructor(id_metrica = 0, id_evento = 0, id_actividad = 0, id_estudiante = 0, nota_quiz = 0, nota_evaluacion = 0, nota_final = 0, check_inicio = 0, check_contenido = 0, count_contenido = 0, check_quiz = 0, check_taller = 0, check_evaluacion = 0, actividad = '', estudiante = '', inicio = '', contenido = '', quiz = '', taller = '', evaluacion = '') {
        this.id_metrica = id_metrica;
...
module.exports = __webpack_require__(/*! C:\Users\sepul\Desktop\FC\src\main.ts */"./src/main.ts");
